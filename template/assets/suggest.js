...
(function ($) {
    ...
    var Suggest = function(el, key, options) {
        ...
        this.alphabet = ['а', 'б', 'в', 'г', 'д', 'е', 'ё', 'ж', 'з', 'и', 'й', 'к', 'л', 'м', 'н', 'о', 'п', 'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'э', 'ю', 'я',
        ...
        this.$dropdown = $('<div />', {
            'class': 'dropdown suggest mt-4' + this.options.dropdownClass,
    ...
    Suggest.prototype = {
        ...
        __keyup: function(e) {
            ...
            for (var i = currentPos; i >= 0; i--) {
                ...
                if (this.alphabet.indexOf( subChar ) != -1 && (isSpaceBefore || !this.options.respectWhitespace)) {
                    this.query = subChar + val.substring(i, currentPos);
