<div class="container">
    ...
    <h4 class="my-5 text-center border-left py-4 border-separator"><span class="text-primary">П</span>рофиль</h4>
    ...
    <h4 class="my-5 text-center border-left py-4 border-separator"><span class="text-primary">C</span>писок студентов</h4>
    <p>{students}</p>

    [/students]

    <p>Вернуться на <a href="/teachers">страницу преподавателей</a></p>
</div>
